...
require (
	...
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/attributevalue v1.10.12 // indirect
	github.com/aws/aws-sdk-go-v2/feature/dynamodb/expression v1.4.39 // indirect
